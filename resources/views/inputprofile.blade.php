...
<div class="profile-form-container">
    <h4 class="form-title">Bikin Profile</h4>

    <form method="post" action="{{ url('profile/input') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="name-fields">
            <div class="form-group">
                ...
                <input type="text" name="nm_depan" class="form-control" required>
            </div>
            <div class="form-group">
                <label>Nama Belakang</label>
                <input type="text" name="nm_belakang" class="form-control" required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="nm_rek" placeholder="Contoh: BSI/namarekening" class="form-control" required>
        </div>
        ...
        <input type="hidden" name="des_singkat" value="none">
        <input type="hidden" name="bio" value="none">
        @else
        <div class="form-group">
        ...
        <div class="form-group">
            <label>Bio</label>
            <textarea id="bio-editor" name="bio" class="form-control" rows="5" placeholder="Masukkan deskripsi di sini..."></textarea>
        ...
        <div class="form-group">
            ...
            <div class="file-upload">
                <input type="file" class="file-upload-input" name="foto_profile" id="potoInput" onchange="previewImage(event)" required>
                <label for="potoInput" class="file-upload-label" id="fileLabel">
                    <i class="fa fa-cloud-upload-alt"></i> Pilih Foto Profile
                </label>
            </div>
            <div class="image-preview">
                <img id="preview" class="preview-image" src="#" alt="Preview Foto Profile">
            </div>
        </div>
