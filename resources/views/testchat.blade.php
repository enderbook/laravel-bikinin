        ...
        <div class="header">
            <div class="header-left">
                <a href="index-2.html" class="logo">
                    <img src="{{url('assets/img/logo.png')}}" width="35" height="35" alt=""> <span>Preclinic</span>
                </a>
            </div>
                            ...
                            <ul class="notification-list">
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media">
											<span class="avatar">
												<img alt="John Doe" src="{{url('assets/img/user.jpg')}}" class="img-fluid rounded-circle">
											</span>
            ...
            <div class="sidebar-inner slimscroll">
                <div class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="chat.html"><span class="chat-avatar-sm user-img"><img src="{{url('assets/img/user.jpg')}}" alt="" class="rounded-circle"><span class="status online"></span></span> John Doe <span class="badge badge-pill bg-danger float-right">1</span></a>
                        </li>
                        <li>
                            <a href="chat.html"><span class="chat-avatar-sm user-img"><img src="{{url('assets/img/user.jpg')}}" alt="" class="rounded-circle"><span class="status offline"></span></span> Richard Miles <span class="badge badge-pill bg-danger float-right">18</span></a>
                        </li>
                        <li>
                            <a href="chat.html"><span class="chat-avatar-sm user-img"><img src="{{url('assets/img/user.jpg')}}" alt="" class="rounded-circle"><span class="status away"></span></span> John Smith</a>
                        </li>
                        <li class="active">
                            <a href="chat.html"><span class="chat-avatar-sm user-img"><img src="{{url('assets/img/user.jpg')}}" alt="" class="rounded-circle"><span class="status online"></span></span> Jennifer <span class="badge badge-pill bg-danger float-right">108</span></a>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <div class="navbar">
                                    <div class="user-details mr-auto">
                                        <div class="float-left user-img m-r-10">
                                            <a href="profile.html" title="Jennifer Robinson"><img src="{{url('assets/img/patient-thumb-02.jpg')}}" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
                                        </div>
                                                ...
                                                <div class="chat chat-left">
                                                    <div class="chat-avatar">
                                                        <a href="profile.html" class="avatar">
                                                            <img alt="Jennifer Robinson" src="{{url('assets/img/patient-thumb-02.jpg')}}" class="img-fluid rounded-circle">
                                                        </a>
                                                    </div>
                                                    <div class="chat-body">
                                                        <div class="chat-bubble">
                                                            ...
                                                            <div class="chat-content img-content">
                                                                <div class="chat-img-group clearfix">
                                                                    ...
                                                                    <a class="chat-img-attach" href="#">
                                                                        <img width="182" height="137" alt="" src="{{url('assets/img/placeholder.jpg')}}">
